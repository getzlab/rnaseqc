...
int main(int argc, char* argv[])
{
    ...
    ValueFlag<int> chimericDistance(parser, "dist", "Set the maximum accepted distance between read mates.  Mates beyond this distance will be counted as chimeric pairs. Default: 2Mb", {"chimeric-distance"});
    ...
    ValueFlag<int> splitDistance(parser, "dist", "Set the maximum distance between aligned blocks of a read.  Reads with aligned blocks separated by more than this distance are counted as split reads, BUT ARE STILL USED IN COUNTS. Default: 100bp", {"split-distance"});
